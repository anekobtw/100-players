...
function EventCard({ event }: { event: { id: number; name: string; name_eng: string; host: string; ip: string; opensAt: number } }) {
  ...
  return (
    <div className="bg-gray-800 rounded-xl p-6 mb-10 flex flex-col border border-gray-700 gap-3.5 max-w-sm mx-auto">
      ...
      <button
        disabled={timeLeft !== 0}
        className={`mx-auto text-center font-bold py-2 px-5 rounded-lg transition ${timeLeft === 0
...
export default function EventsModal() {
  ...
  return (
    <dialog id="events_modal" className="modal">
      <div className="modal-box overflow-hidden text-center">
        <form method="dialog">
        ...
        <Carousel axis="horizontal" infiniteLoop autoPlay interval={5000} showStatus={false}>
