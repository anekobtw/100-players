...
export default function Home() {
  return (
    <div className="hero min-h-screen bg-linear-to-b from-blue-600/10 via-transparent">
      ...
      <div className="hero-content text-center">
        <div>
          ...
          <button className="btn btn-info btn-soft hover:scale-120 transition-all" onClick={() => document.getElementById("events_modal").showModal()}>Ивенты</button>
