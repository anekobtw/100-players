import '../App.css';
import "tailwindcss";
import InfiniteVideoCarousel from './infinitevideocarousel';
      ...
      <section className="hero relative h-screen w-screen bg-linear-to-b from-blue-600/15 via-transparent flex flex-col">
        ...
        <div className="flex gap-20 mb-8">
          <a href="https://www.youtube.com/@Нелис" target="_blank" rel="noopener noreferrer">
            <button className="btn btn-error btn-outline hover:scale-105 transition-all">
          ...
          <a href="https://t.me/+E5fATL5wRxY1Mjky" target="_blank" rel="noopener noreferrer">
            <button className="btn btn-info btn-outline hover:scale-105 transition-all">
        ...
        <button
          className="btn btn-soft hover:scale-120 transition-all"
          onClick={() => document.getElementById("events_modal")?.showModal()}
        >
          Ивенты
        </button>
      </section>
